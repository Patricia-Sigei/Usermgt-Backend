"""creates relationship between permissions and updates role table

Revision ID: 3aca28324181
Revises: d1e46458c530
Create Date: 2025-03-04 13:53:44.810981
...
revision = '3aca28324181'
down_revision = 'd1e46458c530'
branch_labels = None
depends_on = None
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    with op.batch_alter_table('roles', schema=None) as batch_op:
        batch_op.add_column(sa.Column('permissions', postgresql.ARRAY(sa.VARCHAR()), autoincrement=False, nullable=True))
